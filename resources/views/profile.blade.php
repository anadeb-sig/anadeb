...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4 border-bottom">
    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Changer photo de profile</button>
            </div>
        </div>
        <div class="col-xl-9">
            {{-- Profile --}}
            <div class="p-3 py-5">
                ...
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="mt-5 text-center">
                        <button class="btn btn-primary profile-button" type="submit">Mettre à jour!</button>
                    </div>
                </form>
            </div>
            ...
            <div class="p-3 py-5">
                ...
                <form action="{{ route('profile.change-password') }}" method="POST">
                    ...
                    <div class="mt-5 text-center">
                        <button class="btn btn-primary profile-button" type="submit">Valider!</button>
                    </div>
                </form>
            </div>
        </div>
