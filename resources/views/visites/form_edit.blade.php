...
<div class="row {{ $errors->has('contact') ? 'has-error' : '' }}">
    ...
    <div class="col-xl-6 mb-3">
        ...
        <input class="form-control date_visite" name="date_visite" type="date" id="date_visite" placeholder="Entrer le contact ici...">
    ...
    <div class="card-body">
        <div class="row mb-4">
            ...
            <div class="col-xl-4 {{ $errors->has('canton_id') ? 'has-error' : '' }}">
                ...
                <select class="form-control" id="canton_edit" required="true" disabled>
            ...
            <div class="col-xl-4">
                ...
                <select class="form-control ecole_id" id="ecole_edit" name="ecole_id" disabled required="true">
