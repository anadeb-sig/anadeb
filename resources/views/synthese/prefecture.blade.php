...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
        <h1 class="h3 mb-0 text-gray-800">Synthèse /Préfecture <br><a href="#!" class="text_export" onclick="ExportToxcel('xlsx')">... Exporter en excel par recherche multiple du tableau!</a></h1>            
        ...
        <div id="hiddenContent" class="hidden mt-4 mb-4">
            <div class="card card-body mb-0">
                <form method="get" action="" accept-charset="UTF-8">
                    <div class="row mb-4">
                        <div class="col-xl-6">
                            <label for="canton_id" class="control-label">Préfecture</label>
                            <input class="form-control w-100 majuscules" id="nom_pref" name="nom_pref" type="text" placeholder="exemple: ZIO..." />
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="col-xl-1">
                            <a href="{{ route('repas.synthese_prefecture') }}" id="btnP" type="button" class="btn btn-secondary mt-2 recherche">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div id="table_parprefecture"></div>
                </div>
                <!-- end card body -->
            </div>
            <!-- end card -->
    ...
    <script type="text/javascript"> 
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btnP').addEventListener('click', function() {
                ...
                const nom_pref = document.getElementById('nom_pref').value;
                const nom_fin = document.getElementById('nom_fin').value;
                rendtableau_pref(startDate,endDate,nom_pref,nom_fin);
            });
        });
    ...
    <script>
        function hideR(table,rowIndex){
            var elt = document.getElementById('table_parprefecture');
        ...
        function ExportToxcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('prefecture.' + (type || 'xlsx')));
        }
    </script>
