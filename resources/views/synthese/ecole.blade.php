...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
        <h1 class="h3 mb-0 text-gray-800">Synthèse /Cantine <br><a href="#!" class="text_export" onclick="ExportTExcel('xlsx')">... Exporter en excel par recherche multiple du tableau!</a></h1>            
            ...
            <div class="card card-body mb-0">
                <form method="get" action="" accept-charset="UTF-8">
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="col-xl-1">
                            <a href="{{ route('repas.synthese_ecole') }}" id="btnP" type="button" class="btn btn-secondary mt-2 recherche">
    ...
    <script type="text/javascript"> 
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btnP').addEventListener('click', function() {
                ...
                rendtableau_ecl(startDate,endDate,nom_reg,nom_cant,nom_ecl,nom_fin);
            });
        });
    ...
    <script>
        ...
        var elt = document.getElementById('table_parecole');
        ...
        function ExportTExcel(type, fn, dl) {
            var elt = document.getElementById('table_parecole');
            hideRw(  elt,2);
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('ecole.' + (type || 'xlsx')));
        }
    </script>
