...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
        <h1 class="h3 mb-0 text-gray-800">Synthèse /Région <br><a href="#!" class="text_export" onclick="ExportToxce('xlsx')">... Exporter en excel par recherche multiple du tableau!</a></h1>            
                ...
                <form method="get" action="" accept-charset="UTF-8">
                    <div class="row mb-4">
                        <div class="col-xl-6 {{ $errors->has('region_id') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control w-100 majuscules" id="nom_reg" name="nom_reg" type="text" placeholder="exemple: SAVANES..." />
                        </div>
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="col-xl-1">
                            <a href="{{ route('repas.synthese_region') }}" id="btnP" type="button" class="btn btn-secondary mt-2 recherche">
    ...
    <!-- gridjs js
    <script type="module" src="{{ asset('./assets/gridjs/gridjs.synregion.js') }}"></script>
    -->
    <script type="text/javascript"> 
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btnP').addEventListener('click', function() {
                ...
                rendtableau(startDate,endDate,nom_reg,nom_fin);
            });
        });
    ...
    <script>
        function hideR(table,rowIndex){
            var elt = document.getElementById('table_parregion');
        ...
        function ExportToxce(type, fn, dl) {
            var elt = document.getElementById('table_parregion');
            hideR(  elt,2);
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('region.' + (type || 'xlsx')));
        }
    </script>
