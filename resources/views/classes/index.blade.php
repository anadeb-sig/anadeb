...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
        <h1 class="h3 mb-0 text-gray-800">Liste des écoles<br><a href="{{ route('classes.index_zero')}}" class="text_export">... Voir les écoles disposant des effectifs inscrits null!</a></h1>
        @can('repas-create')
