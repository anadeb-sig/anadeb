            ...
            [
                ...
                html(
                  "<div class='btn-group btn-group-xs pull-right' role='group' id='actions'>"+
                    "<a href='roles/edit/"+item.id+"' class='btn btn-primary m-1' title='Editer le rôle'>"+
                        "<span class='fa fa-pen' aria-hidden='true'></span>"+
                    "</a>"+
                    "<a href='javascript:void(0)' id='delete_role' data-id='"+item.id+"' class='btn btn-danger m-1' title='Supprimer le rôle'>"+
